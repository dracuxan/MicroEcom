...
// WithProduct adds the product to the create product params
func (o *CreateProductParams) WithProduct(product *models.Product) *CreateProductParams {
	o.SetProduct(product)
	return o
}

// SetProduct adds the product to the create product params
func (o *CreateProductParams) SetProduct(product *models.Product) {
	o.Product = product
}
